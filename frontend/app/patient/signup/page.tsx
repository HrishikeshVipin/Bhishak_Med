    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Bhishak Med as a Patient</p>
        </div>
        ...
        {step === 2 && (
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            ...
            <button
              ...
              className="w-full text-blue-600 py-2 text-sm font-medium disabled:text-gray-400 disabled:cursor-not-allowed"
            >
          ...
          <form onSubmit={handleCompleteSignup} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                maxLength={6}
              />
              <p className="text-xs text-gray-500 mt-1">You'll use this PIN to login next time</p>
            </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          ...
          <Link href="/patient/login" className="text-blue-600 hover:text-blue-700 font-medium">
            Login
          </Link>
        </div>
      </div>
